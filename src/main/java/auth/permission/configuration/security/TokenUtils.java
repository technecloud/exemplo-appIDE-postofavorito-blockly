...
public class TokenUtils {
  ...
  // 1 hora(s) em segundos
  private Long expiration = new Long(3600);
  ...
  public Boolean validateToken(String token, UserDetails userDetails) {
		List<User> users = userRepository.findByLogin(userDetails.getUsername(), new PageRequest(0, 100)).getContent();
		if (users.isEmpty())
